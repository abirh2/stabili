...
export const SavedPage: React.FC<SavedPageProps> = ({ savedBuildingIds, onToggleSaveBuilding, onSelectBuilding, onNavigate }) => {
  ...
  return <PageContainer maxWidth="1200">
    <div className="mb-6"><h1 className="text-2xl sm:text-3xl font-semibold tracking-tight text-slate-900">Saved buildings</h1><p className="text-sm text-slate-500 mt-1">Stored in this browser as Stabili IDs.</p></div>
