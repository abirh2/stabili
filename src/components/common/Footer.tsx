...
export const Footer: React.FC<FooterProps> = ({ onNavigate }) => {
  return (
    <footer className="surface-base separator w-full border-t py-10 sm:py-12 px-4 sm:px-6 md:px-8 mt-auto">
      <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        {/* Links */}
        <div className="type-metadata flex flex-wrap items-center justify-center gap-5 font-medium">
          <button
        ...
        {/* Copyright */}
        <div className="type-metadata text-center md:text-right">
